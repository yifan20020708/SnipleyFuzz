...
python_files_second_round = [
    f"python /home/SnipleyFuzz/experiment/fuzzers/Snipuzz/snipuzz.py -r {YEELIGHT_RESTOREFILE} -i {YEELIGHT_INITIAL_FOLD} -o {OUTPUT_FOLD} -t {YEELIGHT_TYPE} -d {YEELIGHT_NAME} -c {YEELIGHT_PROBERECORD_FILE}",
    f"python /home/SnipleyFuzz/experiment/fuzzers/Snipuzz/snipuzz.py -r {MIHOME_CAMERA_RESTOREFILE} -i {MIHOME_CAMERA_INITIAL_FOLD} -o {OUTPUT_FOLD} -t {MIHOME_TYPE} -d {MIHOME_CAMERA_NAME} -c {MIHOME_CAMERA_PROBERECORD_FILE}",
    f"python /home/SnipleyFuzz/experiment/fuzzers/Snipuzz/snipuzz.py -r {MIHOME_PLUG_RESTOREFILE} -i {MIHOME_PLUG_INITIAL_FOLD} -o {OUTPUT_FOLD} -t {MIHOME_TYPE} -d {MIHOME_PLUG_NAME} -c {MIHOME_PLUG_PROBERECORD_FILE}"
]
...
def Record_information(index):
    ...
    information_single = []
    folder = "/home/SnipleyFuzz/experiment/output/comparison/share/"
    record = {}
